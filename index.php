...
<body>
    ...
    <div class="container mt-5">
        <div class="jumbotron">
            <h1 class="display-4">¡Bienvenidos a Agenda Telefónica!</h1>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php
                    require_once("models/db.php"); // Asegúrate de que la conexión esté en db.php
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                ...
                                <td>
                                    <!-- Botón Editar -->
                                    <button type='button' class='btn btn-outline-secondary' data-toggle='modal' data-target='#editModal' data-id='{$row['id_usuario']}' data-nombre='{$row['Nombre']}' data-apellido='{$row['Apellido']}' data-identificacion='{$row['Identificación']}' data-telefono='{$row['Telefono']}' data-ubicacion='{$row['Ubicación']}'>
                                        Editar
                                    </button>
                                    <!-- Botón Eliminar -->
